/* reverse_rgb.c -- This is a plug-in for GIMP
...
#define PLUG_IN_PROC   "plug-in-reverse-rgb"
#define PLUG_IN_BINARY "reverse-rgb"
...
query (void)
{
  ...
  gimp_install_procedure (PLUG_IN_PROC,
                          ...
                          "There's no help yet.",
                          "Panchalingamoorthy Gajenthran (p.gajenthran@gmail.com)",
  ...
  *return_vals  = values;
  ...
  switch (run_mode)
    ...
    case GIMP_RUN_INTERACTIVE:
      ...
      if (! reverse_rgb_dialog (drawable))
        return;
      break;
...
/* dialog stuff */
static gint
reverse_rgb_dialog (GimpDrawable *drawable)
{
  GtkWidget *dialog;
  GtkWidget *main_vbox;
  GtkWidget *preview;
